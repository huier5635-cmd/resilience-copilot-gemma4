...
主说明以 [README.md](README.md) 为准。

## 项目定位

Resilience Copilot 是一个面向高风险决策支持的大模型安全智能体原型。项目研究如何在灾害救援 case note 处理中，通过确定性风险识别、行动手册约束、官方资源核验、受限长期记忆、人工复核和审计追踪，提高 LLM Agent 的可靠性与可控性。
...
系统不是自动应急调度工具，也不替代 emergency services。它的目标是把混乱、不确定的救援记录整理成可复核、可交接、可审计的 responder handoff。
