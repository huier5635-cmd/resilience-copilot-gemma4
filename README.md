...
1. Open the [live demo](https://huier5635-cmd.github.io/resilience-copilot-gemma4/) and check the validation badge, example cases, Transfer Brief, Audit Trace, and JSON export.
2. Read the [English README](README_EN.md) for architecture, safety boundaries, validation results, and the agentic roadmap.
3. Open the [V4 pitch deck](resilience_copilot_pitch_v4_command_center.pptx) for the Rescue Command Center storytelling view.
4. Download `resilience_copilot_submission_bundle_EXP029.zip` to reproduce the local validation gate.
